...
json_date = json.loads(json_text)
...
for interface in json_date["ietf-interfaces:interfaces"]["interface"]:
    print(interface["name"])
    print(interface["ietf-ip:ipv4"]["address"][0]["ip"],interface["ietf-ip:ipv4"]["address"][0]["netmask"])
